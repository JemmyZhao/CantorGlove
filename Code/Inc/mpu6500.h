...
#define MPU6500A_2g       ((float)0.00006103515625f)  // 0.000061035156 g/LSB
#define MPU6500A_4g       ((float)0.0001220703125f)  // 0.000122070312 g/LSB
#define MPU6500A_8g       ((float)0.000244140625f)  // 0.000244140625 g/LSB
#define MPU6500A_16g      ((float)0.00048828125f)  // 0.000488281250 g/LSB

#define MPU6500G_250dps   ((float)0.007629394531250f)  // 0.007633587786 dps/LSB
#define MPU6500G_500dps   ((float)0.0152587890625f)  // 0.015267175572 dps/LSB
#define MPU6500G_1000dps  ((float)0.0305175781250f)  // 0.030487804878 dps/LSB
#define MPU6500G_2000dps  ((float)0.0610351562500f)  // 0.060975609756 dps/LSB
