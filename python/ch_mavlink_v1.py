...
MAV_COMP_ID_ROLL_MOTOR = 201
MAV_COMP_ID_PITCH_MOTOR = 202
MAV_COMP_ID_YAW_MOTOR = 203
...
class Mavlink:
    ...
    def mavlink_write_controller_config(self):
        ...
        msg[6] = 1
        for i in range(MAVLINK_MSG_ID_CONTROLLER_CONFIG_DATA_LEN):
            msg[6+i] = 6
        print(msg)
        self.serial_send_buf(msg)
    ...
    def decode_attitude_quaternion(self):
        if self.msg_state == MsgState.MAVLINK_RX_STOP:
            if self.msg_rs.payload_len == MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN:
                ...
                print(self.mav_attitude_quat_pck.time_boot_ms)
